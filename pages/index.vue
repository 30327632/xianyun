    ...
    <div class="banner-content">
      <div class="search-bar">
        ...
        <el-row type="flex" class="search-tab">
          ...
          <span v-for="(item, index) in options" :key="index" @click="currentOption = index" :class="{active:index==currentOption}">
            <i>{{item.title}}</i>
          </span>
        </el-row>
        ...
        <el-row type="flex" align="middle" class="search-input">
          ...
          <input :placeholder="options[currentOption].placeholder" v-model="searchCity" />
          <i class="el-icon-search" @click="handleJump(searchCity)"></i>
        </el-row>
      </div>
    </div>
  </div>
